...
describe('Service Tests', () => {
  describe('Municipio Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Municipio(123, 0, 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Municipio', async () => {
      ...
      it('should not update a Municipio', async () => {
      ...
      it('should partial update a Municipio', async () => {
      ...
      it('should not partial update a Municipio', async () => {
      ...
      it('should return a list of Municipio', async () => {
        const returnedFromService = Object.assign(
          {
            ativo: 1,
            codigoIbge: 1,
      ...
      it('should not return a list of Municipio', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Municipio', async () => {
