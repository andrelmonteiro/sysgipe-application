...
describe('Service Tests', () => {
  describe('Endereco Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Endereco(123, 0, false, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Endereco', async () => {
      ...
      it('should not update a Endereco', async () => {
      ...
      it('should partial update a Endereco', async () => {
      ...
      it('should not partial update a Endereco', async () => {
      ...
      it('should not return a list of Endereco', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Endereco', async () => {
