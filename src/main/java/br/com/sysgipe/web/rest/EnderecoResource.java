...
/**
 * REST controller for managing {@link br.com.sysgipe.domain.Endereco}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Endereco> result = enderecoRepository
            ...
            .map(existingEndereco -> {
                if (endereco.getAtivo() != null) {
                    existingEndereco.setAtivo(endereco.getAtivo());
                }
                if (endereco.getAtual() != null) {
                    existingEndereco.setAtual(endereco.getAtual());
                }
                ...
                if (endereco.getDataExclusao() != null) {
                    existingEndereco.setDataExclusao(endereco.getDataExclusao());
                }
                if (endereco.getUsuarioExclusaoId() != null) {
                    existingEndereco.setUsuarioExclusaoId(endereco.getUsuarioExclusaoId());
                }
